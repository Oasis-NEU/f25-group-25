...
function NavBar() {
    return (
      <div className='bg-slate-800 flex justify-center sticky top-0 z-10 w-full'>
        ...
        <Link to='/settings'>
            <button  className="rounded-full hover:scale-[1.1] transition-all ease-in-out cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="size-6">
